...
class CertificateParameters(BaseModel):
    ...
    certno: str = Field(..., description='Certificate No.', examples=['18XXXXXXX'])
...
class IticrCertificatePostRequest(BaseModel):
...
class IticrCertificatePostResponse(BaseModel):
...
class IticrCertificatePostResponse1(BaseModel):
...
class IticrCertificatePostResponse2(BaseModel):
...
class IticrCertificatePostResponse3(BaseModel):
...
class IticrCertificatePostResponse4(BaseModel):
...
class IticrCertificatePostResponse5(BaseModel):
...
class IticrCertificatePostResponse6(BaseModel):
